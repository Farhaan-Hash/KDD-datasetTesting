...
dfkdd_train = pd.read_table("C:\Users\FARHAAN7\Desktop\pro\PROJECT\KDDTrain.txt+", sep=",", names=datacols) # change path to where the dataset is located.
dfkdd_train = dfkdd_train.iloc[:,:-1] # removes an unwanted extra field

# Load NSL_KDD test dataset
dfkdd_test = pd.read_table("C:\Users\FARHAAN7\Desktop\pro\PROJECT\KDDTest.txt+", sep=",", names=datacols)
